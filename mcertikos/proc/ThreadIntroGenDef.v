...
Section Refinement.
  ...
  Section WITHMEM.
    ...
    Section REFINEMENT_REL.
        ...
        Inductive match_TCB: TCB -> val -> val -> val-> Prop :=
        | MATCH_TCBUNDEF:
            forall v1 v2 v3, match_TCB TCBUndef v1 v2 v3
        | MATCH_TCBVALID: 
            forall v1 v2 v3 ts,
              ZtoThreadState (Int.unsigned v1) = Some ts
              -> match_TCB (TCBValid ts (Int.unsigned v2) (Int.unsigned v3)) (Vint v1) (Vint v2) (Vint v3).

        Inductive match_TCBPool: stencil -> TCBPool -> mem -> meminj -> Prop :=
        | MATCH_TCBPOOL: 
            forall tcb m b f s,
              (forall ofs, 
                 0<= ofs < num_proc ->
