...
(** [CompCertX:test-compcert-param-memory] Rewriting no longer works in the context.
  We have to provide hypotheses explicitly.
  Probably a bug of Coq 8.4pl1? *)
  rewrite Mem.valid_pointer_nonempty_perm in H0 |- *. eauto.
Qed. 
...
Proof.
 ...
 (** [CompCertX:test-compcert-param-memory] This function now depends also on the memory model,
  ...
  exploit (@eval_operation_inj _ _ _ _ ge inject_id).
