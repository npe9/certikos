...
set of the caller is now a parameter of the semantics of both LTL and Linear. For whole
...
Lemma starts_with_correct:
  ...
  find_label lbl c2 = Some c3 ->
  plus (step init_ls) tge (State s f sp c1 ls m)
...
Lemma add_branch_correct:
  ...
  plus (step init_ls) tge (State s tf sp (add_branch lbl k) ls m)
