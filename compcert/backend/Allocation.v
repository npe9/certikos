...
Parameter regalloc: forall `{SelectLong.I64helpers}, RTL.function -> res LTL.function.

(** Register allocation followed by validation. *)

Definition transf_function `{SelectLong.I64helpers} (f: RTL.function) : res LTL.function :=
...
Definition transf_fundef `{SelectLong.I64helpers} (fd: RTL.fundef) : res LTL.fundef :=
  AST.transf_partial_fundef transf_function fd.

Definition transf_program `{SelectLong.I64helpers} (p: RTL.program) : res LTL.program :=
