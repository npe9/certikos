...
(** [CompCertX:test-compcert-param-memory] We have to move these Ltac definitions here
  to the top level, to escape the [WITHMEM] section below.
  Indeed, they are reused in [SelectOpproof]. *)
Ltac FuncInv :=
  match goal with
